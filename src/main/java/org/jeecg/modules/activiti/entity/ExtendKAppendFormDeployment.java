 ...
 */
@Data
@TableName("extend_k_append_form_deployment")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@ApiModel(value="extend_k_append_form_deployment对象", description="extend_k_append_form_deployment")
public class ExtendKAppendFormDeployment implements Serializable {
